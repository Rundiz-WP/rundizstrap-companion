...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsNavbarResponsiveWrapper')) {
    /**
     * Bootstrap navbar responsive wrapper class.
     * 
     * @since 0.0.1
     */
    class BsNavbarResponsiveWrapper implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
