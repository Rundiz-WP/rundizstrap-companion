...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsPostNavigationLink')) {
    /**
     * Bootstrap post navigation link class.
     * 
     * @since 0.0.1
     */
    class BsPostNavigationLink implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
