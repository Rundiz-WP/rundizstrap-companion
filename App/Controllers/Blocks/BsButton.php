...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsButton')) {
    /**
     * Bootstrap button class.
     * 
     * @since 0.0.1
     */
    class BsButton implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
         ...
         */
        private const BLOCK_NAME = 'bs-button';
