<?php
/**
 * Bootstrap Basic FSE Plugin - Bootstrap comment form block.
 * 
...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsCommentForm')) {
    /**
     * Bootstrap comment form class.
     * 
     * @since 0.0.1
     */
    class BsCommentForm implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
         ...
         */
        private const BLOCK_NAME = 'bs-comment-form';
