...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsNavbarContainer')) {
    /**
     * Bootstrap navbar container class.
     * 
     * @since 0.0.1
     */
    class BsNavbarContainer implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
