...
if (!class_exists('\\BBFSEPlugin\\App\\Controllers\\Blocks\\BsRow')) {
    /**
     * Bootstrap layout row class.
     * 
     * @since 0.0.1
     */
    class BsRow implements \BBFSEPlugin\App\Controllers\ControllerInterface
    {
         ...
         */
        private const BLOCK_NAME = 'bs-row';
